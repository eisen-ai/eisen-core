    ...
    def __init__(self, data_dir, training, transform=None):
        ...
        if self.training:
            train_dir = os.path.join(
                self.data_dir, "boneage-training-dataset", "boneage-training-dataset"
            )
            labels = read_bone_age_kaggle_label_csv(
                os.path.join(data_dir, "boneage-training-dataset.csv"), True
            )
            ...
            for image in images:
                ...
                item = {
                    "image": os.path.join(
                        "boneage-training-dataset", "boneage-training-dataset", image
                    ),
            ...
            test_dir = os.path.join(
                self.data_dir, "boneage-test-dataset", "boneage-test-dataset"
            )
            metadata = read_bone_age_kaggle_label_csv(
                os.path.join(data_dir, "boneage-test-dataset.csv"), False
            )
            ...
            for image in images:
                ...
                item = {
                    "image": os.path.join(
                        "boneage-test-dataset", "boneage-test-dataset", image
                    ),
